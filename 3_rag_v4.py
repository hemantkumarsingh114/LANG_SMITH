...
def load_pdf(path: str):
    return PyMuPDFLoader(path).load()  # list[Document]
...
# 4)----------------- explicitly traced load/build runs -----------------
...
def setup_pipeline(pdf_path: str, chunk_size=1000, chunk_overlap=150, embed_model_name="gemini-embedding-001", force_rebuild=False):
